...
void BP_eimu(double M, double a, double epsilon3, double *y ,double eimuBP[4][4], double emuiPB[4][4]);
...
void Scatter(Photon *gamma_p, double u[4], double f_corona[4],double Tcorona, double eimuBP[4][4], double emuiPB[4][4], double fac);
